...
import com.ruanthiago.todoList.model.Task;
import com.ruanthiago.todoList.service.TaskService;
...
public class TaskController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Não foi possível excluir tarefa")
    } )
